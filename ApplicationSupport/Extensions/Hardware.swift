...
public let IS_IPHONE_XR: Bool = (IS_IPHONE && UIScreen.main.nativeBounds.size.height == 1792.0)
public let IS_IPHONE_XS_MAX: Bool = (IS_IPHONE && UIScreen.main.nativeBounds.size.height == 2688.0)
